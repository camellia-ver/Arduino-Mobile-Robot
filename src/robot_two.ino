...
// ===== 로봇 초기 설정 =====
// 로봇의 시작 위치 설정 (x, y 좌표)
const int ROBOT_START_X = 5, ROBOT_START_Y = 6;
...
uint8_t mapGrid[MAP_ROWS][MAP_COLS] = {0};  // 맵 초기화 (모두 0으로 설정)
...
void setup() {
  ...
  Serial.println("로봇2 시작: RFID 카드 인식 대기 중...");
}
